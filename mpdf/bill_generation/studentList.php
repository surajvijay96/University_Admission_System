...
$qlist = "select * from profile p, fees f where f.usn=p.usn and f.sem=p.sem and p.sem in ($sem1,$sem2) and p.branch like '".$branch."' and f.amount!=0 and allowed like 'true'";//echo "$qlist";
