<?php
	...
	$check = "select priority from login where username like '".$delete."' ";
	...
	if($userPriv == '1')
	{
		$admins = "select id from login where priority = '1'";
	...
	if(!isset($delete))
	{
	$update = "update login set username='".$user."',password='".$password."',priority='".$priv."' where username like '".$actualuser."'";
